...
<div 
	class="flex items-center bg-gray-50 rounded overflow-hidden" 
	in:fly={{y: -20}} 
	out:fly={{x: 20}}
>
	<div 
		...
		class:bg-rose-500={type == types.DANGER}
	>
	...
	<button class="w-16 h-16 grid place-content-center active:scale-95 hover:bg-gray-100 transition" on:click={remove}>
		<XIcon size="20" />
	</button>
</div>